...
BASE_OUT = SEED / "baseline_prompt19_direct_experiment_more20configs"
MOTION_OUT = MOTIONS / "baseline_prompt19_direct_experiment_more20configs"
...
HTML_OUT = BASE_OUT / "prompt19_baseline_experiment_more20configs_compare_20260408_ko.html"
FALLBACK_GEMINI_KEY_FILE = Path("/Users/sb/Downloads/workspace/Motion2Mind/src/motion2mind/vlm/delete_gemini.py")


TARGETS = [
    {"dataset": "iconic", "idx": 37, "cue": "yield_turn"},
    {"dataset": "iconic", "idx": 38, "cue": "interrupt_cue"},
    {"dataset": "iconic", "idx": 39, "cue": "request_turn"},
    {"dataset": "iconic", "idx": 40, "cue": "guiding_arm"},
    {"dataset": "iconic", "idx": 41, "cue": "protective_arm_out"},
    {"dataset": "iconic", "idx": 45, "cue": "slow_down_request_palm_down"},
    {"dataset": "iconic", "idx": 46, "cue": "speed_up_circular_cue"},
    {"dataset": "iconic", "idx": 47, "cue": "wait_for_me_backward_palm"},
    {"dataset": "iconic", "idx": 48, "cue": "continue_on_forward_roll"},
    {"dataset": "iconic", "idx": 51, "cue": "hesitant_accept_half_reach"},
    {"dataset": "contextual", "idx": 16, "cue": "arms_open_welcome"},
    {"dataset": "contextual", "idx": 17, "cue": "stretch_arms_up"},
    {"dataset": "contextual", "idx": 18, "cue": "gentle_retreat_motion"},
    {"dataset": "contextual", "idx": 19, "cue": "disagreement_cross_then_release"},
    {"dataset": "contextual", "idx": 20, "cue": "stop_entry_cross_block"},
    {"dataset": "contextual", "idx": 21, "cue": "allow_entry_open_side"},
    {"dataset": "contextual", "idx": 22, "cue": "relief_release_drop"},
    {"dataset": "contextual", "idx": 23, "cue": "frustration_down_throw"},
    {"dataset": "contextual", "idx": 25, "cue": "submission_lowered_open_palm"},
    {"dataset": "contextual", "idx": 26, "cue": "dominance_high_open_hold"},
]
...
<head>
  ...
  <title>Prompt19 Baseline Experiment</title>
  <style>
...
<body>
  <main class="wrap">
    <h1>Prompt 19 Baseline Experiment</h1>
    <p class="lead">iconic 5개, contextual 5개에 대해 baseline 3종을 비교합니다: no-reasoning structured, direct joint-angle, direct xyz-theta.</p>
