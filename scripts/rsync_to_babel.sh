...
echo "  sbg2 --export=ALL,MODEL_SIZE=32b,ONLY=10,MOTION_PREPARE_PAIRWISE=0 scripts/sbatch_pilot90_qwen.sh"
echo "  sbg2 --export=ALL,MODEL_SIZE=7b,ONLY=10,MOTION_PREPARE_PAIRWISE=0 scripts/sbatch_pilot90_qwen.sh"
echo "  sbg4 --export=ALL,MODEL_SIZE=3b,ONLY=10,MOTION_PREPARE_PAIRWISE=0 scripts/sbatch_pilot90_qwen.sh"
