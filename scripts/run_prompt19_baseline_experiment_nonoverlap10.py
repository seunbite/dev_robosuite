...
BASE_OUT = SEED / "baseline_prompt19_direct_experiment_nonoverlap10"
MOTION_OUT = MOTIONS / "baseline_prompt19_direct_experiment_nonoverlap10"
...
HTML_OUT = BASE_OUT / "prompt19_baseline_experiment_nonoverlap10_compare_20260406_ko.html"
...
TARGETS = [
    ...
    {"dataset": "iconic", "idx": 54, "cue": "final_decision_down_press"},
    {"dataset": "iconic", "idx": 57, "cue": "unsure_response_hand_hover_stop"},
    {"dataset": "iconic", "idx": 58, "cue": "prevent_fall_support_reach"},
    {"dataset": "contextual", "idx": 35, "cue": "abandon_action_drop_turn"},
    ...
    {"dataset": "contextual", "idx": 41, "cue": "small_rhythmic_bounce"},
]
...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1" />
    <title>Prompt19 Baseline Experiment Nonoverlap 10</title>
  <style>
...
<body>
  <main class="wrap">
    <h1>Prompt 19 Baseline Experiment Nonoverlap 10</h1>
    <p class="lead">shot cue와 덜 겹치는 뒤쪽 10개에 대해 baseline 3종을 비교합니다: no-reasoning structured, direct joint-angle, direct xyz-theta.</p>
