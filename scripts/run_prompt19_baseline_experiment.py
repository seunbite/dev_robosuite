...
BASE_OUT = SEED / "baseline_prompt19_direct_experiment"
MOTION_OUT = MOTIONS / "baseline_prompt19_direct_experiment"
...
HTML_OUT = BASE_OUT / "prompt19_baseline_experiment_compare_20260406_ko.html"
FALLBACK_GEMINI_KEY_FILE = Path("/Users/sb/Downloads/workspace/Motion2Mind/src/motion2mind/vlm/delete_gemini.py")


TARGETS = [
    {"dataset": "iconic", "idx": 0, "cue": "wave_hi"},
    {"dataset": "iconic", "idx": 10, "cue": "shrug_idk"},
    {"dataset": "iconic", "idx": 15, "cue": "beckon_come_here"},
    {"dataset": "iconic", "idx": 32, "cue": "throat_cut_stop"},
    {"dataset": "iconic", "idx": 36, "cue": "visor_search"},
    {"dataset": "contextual", "idx": 5, "cue": "tilt_head_curious"},
    {"dataset": "contextual", "idx": 7, "cue": "shh_gesture"},
    {"dataset": "contextual", "idx": 15, "cue": "hands_up_surrender"},
    {"dataset": "contextual", "idx": 33, "cue": "retry_action_reset_circle"},
    {"dataset": "contextual", "idx": 44, "cue": "listening_lean_substitute"},
]
...
def extract_shot_sequences(
    ...
    shot_render_dir = MOTIONS / "baseline_prompt19_direct_experiment" / "shot_examples" / robot
    ...
    gen = MotionGenerator(
        ...
        output_dir=str(MOTIONS / "baseline_prompt19_direct_experiment" / "shot_examples"),
        has_renderer=False,
