...
OUT_ROOT = SEED / "q4_prompt_refresh_experiment_extra5"
MOTION_OUT = MOTIONS / "q4_prompt_refresh_experiment_extra5" / "IIWA" / "IIWA"
...
ICONIC_OUT = OUT_ROOT / "motion_configs_prompt_v19_sophisticated_q4_prompt_refresh_extra5_iconic.json"
CONTEXTUAL_OUT = OUT_ROOT / "motion_configs_prompt_v19_sophisticated_q4_prompt_refresh_extra5_contextual.json"
HTML_OUT = OUT_ROOT / "prompt19_sophisticated_q4_prompt_refresh_extra5_compare_20260404_ko.html"
...
TARGETS = [
    ...
    {"dataset": "iconic", "idx": 52, "cue": "cancel_previous_offer_retract"},
    {"dataset": "iconic", "idx": 57, "cue": "unsure_response_hand_hover_stop"},
    {"dataset": "contextual", "idx": 43, "cue": "shame_shy_substitute"},
]
...
def generate() -> None:
    ...
    for spec in TARGETS:
        ...
        target_ids = {50, 51, 52, 57} if spec["dataset"] == "iconic" else {43}
...
<head>
  ...
  <title>Prompt19 Sophisticated Q4 Prompt Refresh Extra 5</title>
  <style>
...
<body>
  <main class="wrap">
    <h1>Prompt 19 Sophisticated Q4 Prompt Refresh Extra 5</h1>
