...
MOTION_DIR = MOTIONS / "v19_sophisticated_contextual_q4filled" / "IIWA"
OUT_DIR = SEED / "q4_fill_sophisticated_contextual"
OUT_HTML = OUT_DIR / "prompt19_sophisticated_contextual_q4_filled_rendered_20260405_ko.html"
...
def _find_gif(cue: str, cue_idx: int) -> Path | None:
...
<head>
  ...
  <title>Prompt 19 Sophisticated Contextual Q4 Filled Rendered</title>
  <style>
...
<body>
  <main class="wrap">
    <h1>Prompt 19 Sophisticated Contextual Q4 Filled Rendered</h1>
    <p class="lead">업데이트된 contextual 45개를 다시 렌더한 결과와 reasoning/config를 함께 보여줍니다.</p>
    <p class="meta">motion dir: {html.escape(str(MOTION_DIR))}</p>
