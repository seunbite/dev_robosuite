...
Usage:
    python adhoc/robotarm/export_all_poses_once.py --robot IIWA
    python adhoc/robotarm/export_all_poses_once.py --robot Panda --output data/poses/all_panda_poses.jsonl
"""
...
def main(
    ...
    Examples:
        ...
        python adhoc/robotarm/export_all_poses_once.py --robot Panda --output-file my_poses.jsonl
        
        # Custom angle range
        python adhoc/robotarm/export_all_poses_once.py --robot Kinova3 --angle-step 45
    """
    print("="*60)
