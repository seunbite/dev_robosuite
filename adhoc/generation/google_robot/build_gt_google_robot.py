#!/usr/bin/env python3
"""Build data/seed/groundtruth/gt_google_robot.json (90 cues, same sources as manipulator GT)."""
...
from pilot40_paths import GT_PATH, MANIFEST_TSV  # noqa: E402
