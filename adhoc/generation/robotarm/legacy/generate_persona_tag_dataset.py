...
def main(
    input_json: str = "data/results/motion_configs/manipulator/motion_configs_prompt_v18.json",
    tag_catalog_path: str = "data/seed/yml/persona_tag_catalog.yml",
    cue_subset_path: str = "data/seed/yml/persona_cue_subset_v1.yml",
