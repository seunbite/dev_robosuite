...
def get_recent_motions(
    ...
    if output_format == "idx":
        ...
        if not output_file:
            output_file = "data/results/motion_configs/manipulator/motion_config_recent.json"
...
def print_usage():
    ...
    print("  python get_recent_motions.py --output_format=json --output_file=data/seed/_remainder/best_configs.json")
    print()
    print("  # Verbose mode")
