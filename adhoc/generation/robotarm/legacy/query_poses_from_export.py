...
Usage:
    python adhoc/generation/robotarm/query_poses_from_export.py --robot IIWA --roll 0 --gripper_orientation 90 --yaw 0
    python adhoc/generation/robotarm/query_poses_from_export.py --robot Panda --roll 180 --yaw 0 --height high
"""
...
def query_closest_poses(
    ...
    Examples:
        ...
        # With height filter
        python adhoc/generation/robotarm/query_poses_from_export.py --robot Panda --roll 180 --yaw 0 --height high --top-k 50
        
        # Save tile image
        python adhoc/generation/robotarm/query_poses_from_export.py --robot IIWA --roll 0 --gripper_orientation 90 --yaw 0 --save-tile-image
        
        # Custom tile output
        python adhoc/generation/robotarm/query_poses_from_export.py --robot Panda --roll 180 --yaw 0 --save-tile-image --tile-output my_poses.png
    """
    print("\n" + "="*60)
    ...
    if not Path(input_file).exists():
        ...
        print(f"\nPlease run first:")
        print(f"  python adhoc/generation/robotarm/export_all_poses_once.py --robot {robot}")
        return None
