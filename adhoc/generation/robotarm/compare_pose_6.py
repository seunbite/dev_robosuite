#!/usr/bin/env python3
"""Exp 5: 6-tile pose comparison (multitile GT identification)."""
...
def main() -> None:
    p = argparse.ArgumentParser(description="Exp 5 — compare pose (6-tile grid)")
    ...
    p.add_argument("--image-dir", type=Path, default=DEFAULT_IMG_DIR.parent / "pose_multitile_gt_pilot90_grid6")
    p.add_argument("--out-json", type=Path, default=DEFAULT_OUT.parent / "pilot90_pose_multitile_grid6.json")
