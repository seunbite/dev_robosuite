"""Language Model Programming (LMP) utilities for Code as Policies."""
...
class LMP:
    """Language Model Programming class for code generation."""
    ...
    def __call__(self, query, context='', **kwargs):
        """Generate and execute code for given query."""
...
class LMPFGen:
    """Function generator for Language Model Programming."""
    ...
    def create_f_from_sig(self, f_name, f_sig, other_vars=None, fix_bugs=False, return_src=False):
        """Create function from signature."""
    ...
    def create_new_fs_from_code(self, code_str, other_vars=None, fix_bugs=False, return_src=False):
        """Create new functions from code string."""
        fs, f_assigns = {}, {}
...
class FunctionParser(ast.NodeTransformer):
    """AST parser for extracting functions from code."""
...
def var_exists(name, all_vars):
    """Check if variable exists in given scope."""
    try:
        eval(name, all_vars)
    except:
        exists = False
